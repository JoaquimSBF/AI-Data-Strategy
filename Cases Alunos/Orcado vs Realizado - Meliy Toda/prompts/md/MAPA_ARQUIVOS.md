# Mapa de arquivos — Painel de desvio (Meliy Toda)

Pasta raiz: `Cases Alunos/Orcado vs Realizado - Meliy Toda/`
...
| 01 | `prompts/md/01_limpar.md` | `centros_custo.csv`, `orcamento.csv`, `realizado.csv`, `metas.csv` | `dados/` | `outputs/` |
| 02 | `prompts/md/02_desvio.md` | CSVs da etapa 01 | `outputs/` | `outputs/02_desvio.json` |
| 03 | `prompts/md/03_contrato.md` | `02_desvio.json` | `outputs/` | `outputs/03_contrato_produto.md` |
